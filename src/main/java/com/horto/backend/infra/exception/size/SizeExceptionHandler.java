package com.horto.backend.infra.exception.size;
...
public class SizeExceptionHandler {
    ...
    public ResponseEntity<GlobalExceptionHandler.ErrorResponse> handleCategoryNotFoundException(SizeNotFoundException ex) {
    ...
    @ExceptionHandler(SizeAlreadyExists.class)
    public ResponseEntity<GlobalExceptionHandler.ErrorResponse> handleCategoryAlreadyExists(SizeAlreadyExists ex) {
        GlobalExceptionHandler.ErrorResponse error = new GlobalExceptionHandler.ErrorResponse(
